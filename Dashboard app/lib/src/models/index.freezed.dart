...
class _$AppState$ implements AppState$ {
  const _$AppState$(
      {this.auth = const AuthState(), this.dangers = const DangerState()});
...
abstract class AppState$ implements AppState {
  const factory AppState$({final AuthState auth, final DangerState dangers}) =
      _$AppState$;
...
class _$Danger$ implements Danger$ {
  ...
  @override
  String toString() {
    return 'Danger(uid: $uid, type: $type, latitude: $latitude, longitude: $longitude, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, type, latitude, longitude, status);
...
class _$DangerState$ implements DangerState$ {
  const _$DangerState$(
      ...
      final List<Danger> allDangers = const <Danger>[]})
      : _dangers = dangers,
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._allDangers, _allDangers));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_allDangers));
...
abstract class DangerState$ implements DangerState {
  const factory DangerState$(
      ...
      final List<Danger> allDangers}) = _$DangerState$;
